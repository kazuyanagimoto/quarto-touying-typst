// Clean theme for Touying -- vendored here for in-repo development.
// Origin: https://github.com/kazuyanagimoto/touying-quarto-clean (touying 0.5.3).
// Updated import for touying 0.7.3. Intended to move back to its own repo once
// the spec settles.
