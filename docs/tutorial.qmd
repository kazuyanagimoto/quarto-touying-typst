...
The styled **`clean`** theme is loaded this way, and its title slide also takes
...
colour palette, exactly like the built-in themes. The `clean` (Universe) and
`bamboo` (custom) decks on the [Gallery](gallery.qmd) page are live examples.
