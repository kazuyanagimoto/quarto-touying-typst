...
::: {layout-ncol=2}
![`# In the morning` → a section divider](images/tutorial/section.png)

![`## Getting up` → a content slide](images/tutorial/slide.png)
:::
...
![The title slide for the deck above](images/tutorial/title.png){width=70%}
...
![Each item appears on its own step](images/tutorial/incremental.png)
...
![Columns honour the `width` attribute](images/tutorial/columns.png)
...
```yaml
format: touying-typst
theme: dewdrop   # metropolis | university | dewdrop | aqua | stargazer
                 # simple | default | clean
```
...
Markdown. Two useful front-matter options:
